...
public class mailMgr : MailMessage
{
    ...
    public mailMgr()
    {
        ...
        myFrom = "appdev4y@gmail.com";
        myTo = "rssalmutairi99@sm.imamu.edu.sa";
        ...
        //myPortNumber = 587;
        //myEnableSSL = true;
        //myUserName = "developemail.reham@gmail.com";//"ajalzahrani1@gmail.com";
        //myPassword = "re344658";//"atheer@22";
        myHostsmtpAddress = "smtp.gmail.com";//"smtp.mail.yahoo.com";  //mail.wdbcs.com 
        myPortNumber = 587;
        myEnableSSL = true;
        myUserName = "appdev4y@gmail.com";//
        myPassword = "aowhaqeyqiarghyr";//
    }
    // use this one 
