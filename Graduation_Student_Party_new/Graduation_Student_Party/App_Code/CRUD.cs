...
namespace Graduation_Student_Party.App_Code
{
    ...
    public class CRUD
    {
        ...
        public static string conStr = WebConfigurationManager.ConnectionStrings["GraduationStudentPartyConStr"].ConnectionString;
        // I create a con object once and then use it in methods
        public SqlConnection con = new SqlConnection(WebConfigurationManager.ConnectionStrings["GraduationStudentPartyConStr"].ConnectionString);
        public CRUD()
        {
            //
